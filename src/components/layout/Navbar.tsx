...
export function Navbar({
  ...
  const getPlaceholder = () => {
    if (pathname?.includes("/marketplace")) return "Search products, sellers...";
    if (pathname?.includes("/news")) return "Search news & articles...";
    if (pathname?.includes("/jobs")) return "Search jobs & gigs...";
    return "Search...";
  };
