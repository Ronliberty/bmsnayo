...
export default function NoticePage() {
  return (
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary to-secondary px-6">
      <div className="max-w-md w-full bg-white/15 backdrop-blur-md rounded-2xl shadow-2xl p-8 text-center text-white">
        <h1 className="text-3xl sm:text-4xl font-bold mb-4">
          Important Notice
        </h1>

        <p className="text-base sm:text-lg opacity-90 mb-6">
          We are currently onboarding a limited number of partners.
